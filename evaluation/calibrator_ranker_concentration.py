...
parser = argparse.ArgumentParser(description="a calibrator trained based on the ranker-based-concentration")
...
test_summary = torch.load(f"results/{args.model}_{args.dataset}/ranker_concentration/{args.dataset}_test_uq_{args.reranker}_ranker_concentration.pt", weights_only=False)
train_summary = torch.load(f"results/{args.model}_{args.dataset}/ranker_concentration/{args.dataset}_train_uq_{args.reranker}_ranker_concentration.pt", weights_only=False)
val_summary = torch.load(f"results/{args.model}_{args.dataset}/ranker_concentration/{args.dataset}_val_uq_{args.reranker}_ranker_concentration.pt", weights_only=False)
