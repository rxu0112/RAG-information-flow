...
parser = argparse.ArgumentParser(description="SHAP BGE")
...
if "Llama" in args.setup:
    ...
    save_path = f"results/{args.setup}/shap_BGE-v2-m3_collection.pt"
    ...
    prediction_path = f'results/{args.setup}/prediction_collection_bf16.json'
    save_path = f"results/{args.setup}/shap_BGE-v2-m3_replacement.pt"
...
path = '...' # model path of bge-reranker-v2-m3
