...
from Other_Baselines.ragu.semantic_uncertainty.uncertainty.models.base_model import BaseModel
from Other_Baselines.ragu.semantic_uncertainty.uncertainty.models.base_model import STOP_SEQUENCES
...
class HuggingfaceModel(BaseModel):
    ...
    def __init__(self, model_name, stop_sequences=None, max_new_tokens=None):
        ...
        if 'gemma' in model_name.lower():
            ...
            if ('9b' in model_name) or ('2b' in model_name) or eightbit:
                ...
                self.model = AutoModelForCausalLM.from_pretrained(
                    f"{base}/{model_name}", device_map="auto",
                    max_memory={0: '80GIB', 1: '80GIB'}, **kwargs,) #max_memory={0: '80GIB', 1: '80GIB'}
            ...
            if '/nfs/' in model_name:
                ...
                base = 'hugging-quants'
                model_name = model_name.split('hugging-quants/')[1]
            ...
            llama3_70b = '70B' in model_name

            if ('8B' in model_name) or ('hugging-quants' in model_name) or eightbit:
                self.model = AutoModelForCausalLM.from_pretrained(
                    f"{base}/{model_name}", device_map="auto",
                    max_memory={0: '80GIB'}, **kwargs,)
            else:
    ...
    def predict(self, input_data, temperature, return_full=False):
        ...
        if full_answer.startswith(input_data):
            ...
            # see what's this??? our model does not have this but the '\n\n' thing
            input_data_offset = 0
            full_answer = full_answer.split("\n\n")[0]
        ...
        #print('full_answer', full_answer, stop_at)
        #print('truncated answer', full_answer[:input_data_offset + stop_at])
        #print('token_stop_index', token_stop_index)
        #print(self.tokenizer(full_answer[:input_data_offset + stop_at], return_tensors="pt")['input_ids'])
