...
def main():
    ...
    parser.add_argument('--input_file', type=str, default='、ragu/data/retrieval_output.jsonl')
    parser.add_argument('--top_n', type=int, default=5,
                        help="number of paragraphs to be considered.")
    parser.add_argument('--result_fp', type=str, default='ragu/data/run_baseline_lm.jsonl')
