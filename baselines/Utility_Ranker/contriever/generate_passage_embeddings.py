    ...
    with torch.no_grad():
        for k, p in enumerate(passages):
            ...
            if args.normalize_text:
                text = Utility_Ranker.contriever.src.normalize_text.normalize(text)
...
def main(args):
    ...
    passages = Utility_Ranker.contriever.src.data.load_passages(args.passages)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Directory where passage embeddings are written",
    )
